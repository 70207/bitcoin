...
ACLOCAL = ${SHELL} /space/workspace/2btc/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /space/workspace/2btc/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /space/workspace/2btc/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /space/workspace/2btc/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
BOOST_LIBS = -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lboost_chrono -L/usr/local/mysql/lib -lmysqlclient -ldl
...
MAINT = 
MAKEINFO = ${SHELL} /space/workspace/2btc/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /space/workspace/2btc
abs_srcdir = /space/workspace/2btc
abs_top_builddir = /space/workspace/2btc
abs_top_srcdir = /space/workspace/2btc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /space/workspace/2btc/build-aux/install-sh
